...
public struct ez {
    ...
    public static var appDisplayName: String? {
        if let bundleDisplayName = Bundle.main.objectForInfoDictionaryKey("CFBundleDisplayName") as? String {
            return bundleDisplayName
        } else if let bundleName = Bundle.main.objectForInfoDictionaryKey("CFBundleName") as? String {
            return bundleName
        }
    ...
    public static var currentRegion: String? {
        return Locale.current.object(forKey: Locale.Key.countryCode) as? String
    }

    /// EZSE: Calls action when a screen shot is taken
    public static func detectScreenShot(_ action: () -> ()) {
    ...
    public static func runThisInBackground(_ block: () -> ()) {
    ...
    public static func runThisEvery(seconds: TimeInterval, startAfterSeconds: TimeInterval, handler: (CFRunLoopTimer?) -> Void) -> Timer {
    ...
    public static func requestImage(_ url: String, success: (UIImage?) -> Void) {
    ...
    public static func requestJSON(_ url: String, success: ((AnyObject?) -> Void), error: ((NSError) -> Void)?) {
        requestURL(url,
    ...
    private static func dataToJsonDict(_ data: Data?) -> AnyObject? {
        if let d = data {
            var error: NSError?
            let json: AnyObject?
            do {
    ...
    /// EZSE:
    private static func requestURL(_ url: String, success: (Data?) -> Void, error: ((NSError) -> Void)? = nil) {
